...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/boot.css?v=10" />
        <link rel="stylesheet" href="css/stylemain.css?v=12" />
        <link rel="stylesheet" media="screen and (min-width: 0px) and (max-width: 1023px)" href="css/style1.css?v=10"/>
        <link rel="stylesheet" media="screen and (min-width: 1024px) and (max-width: 1279px)" href="css/style2.css?v=10"/>
        <link rel="stylesheet" media="screen and (min-width: 1280px) and (max-width: 1359px)" href="css/style3.css?v=10"/>
        <link rel="stylesheet" media="screen and (min-width: 1360px) and (max-width: 1599px)" href="css/style4.css?v=12"/>
        <link rel="stylesheet" media="screen and (min-width: 1600px) and (max-width: 1919px)" href="css/style5.css?v=10"/>
        <link rel="stylesheet" media="screen and (min-width: 1920px)" href="css/style6.css?v=10"/>
