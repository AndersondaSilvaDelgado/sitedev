<div class="form_create">
    ...
    <article>
        ...
        <header >
            <h1 class="title_crud">RELATORIO DE LOG DE ACESSO - DOCUMENTAÇÃO</h1>
        </header>

        <div class="content">

            <form name="form" action="painel.php?exe=relatorio/relatorio_log_doc" method="post" enctype="multipart/form-data">

                <div class="label_line">

                    <label class="label_medium">
                        <span class="field">Data Inicial:</span>
                        <input 
                            type="date" 
                            class="center" 
                            name="DATAINICIAL" 
