        ...
        <div class="content padrao">
            ...
            <ul>
                ...
                <div class="imagem_padrao imagem_esquerda">
                    <img src="themes/img/treinamento.jpg" alt="<?= ($idioma == 1) ? 'Treinamento - Desenvolvimento de Liderança' : 'Training - Leadership Development'; ?>" title="<?= ($idioma == 1) ? 'Treinamento - Desenvolvimento de Liderança' : 'Training - Leadership Development'; ?>"/>
                    <h1><?= ($idioma == 1) ? 'Treinamento - Desenvolvimento de Liderança' : 'Training - Leadership Development'; ?></h1>
                </div>
