        ...
        <?php else: ?>
            ...
            <article class="slide_item">
                <a id="link_imagem" href="index.php?exe=principios">
                    <img id="imagem_principal" src="themes/img/imagem01.jpg" alt="<?= ($idioma == 1) ? 'Imagem Panorâmica da Usina Santa S.A.' : 'Panoramic view of the Usina Santa S.A.'; ?>" title="<?= ($idioma == 1) ? 'Imagem Panorâmica da Usina Santa S.A.' : 'Panoramic view of the Usina Santa S.A.'; ?>"/>
