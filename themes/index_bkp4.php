<main>
    <section class="container relacao">
        <div class="content">
			<section class="localizacao senai">
				<h1 class="tit_senai">Primeira lista dos aprovados no Processo Seletivo Aprendiz</h1>
					<a href="#" onclick="document.getElementById('lista').style.display='block'">
					<p class="tagline"><b>CLIQUE AQUI</b></p>
				</a>
			</section>
			<div class="clear"></div>
        </div>
		
		<div id="lista" class="w3-modal">
			<div class="w3-modal-content">
				<header class="w3-container w3-blue"> 
				<span onclick="document.getElementById('lista').style.display='none'" 
				class="w3-button w3-display-topright">&times;</span>
				<h2>Lista de Aprovados</h2>
				</header>
				<div class="w3-container">
					<iframe src="themes/arquivos/lista_aprovado.pdf#toolbar=0&scrollbar=0&navpanes=1" width="100%" height="550px"></iframe>
				</div>
			</div>
		</div>
    ...
    <section class="slide container">
        ...
        if ($verDisp):
			...
			<a href="themes/arquivos/plano_covid.pdf?v=2">
