        ...
        <?php else: ?>
            ...
            <article class="slide_item">
                <a id="link_imagem" href="index.php?exe=principios">
                    <img id="imagem_principal" src="themes/img/imagem01.jpg?v=1" alt="<?= ($idioma == 1) ? 'Imagem Panorâmica da Usina Santa S.A.' : 'Panoramic view of the Usina Santa S.A.'; ?>" title="<?= ($idioma == 1) ? 'Imagem Panorâmica da Usina Santa S.A.' : 'Panoramic view of the Usina Santa S.A.'; ?>"/>
        ...
        <div class="content">
            ...
            <a href="index.php?exe=acesso_relacao">
                <article class="item_index" title="<?= ($idioma == 1) ? 'Relação com Instituições Financeiras' : 'Relations with Financial Institutions'; ?>">
                    <p class="tagline"><i class="fa fa-users"></i></p>
